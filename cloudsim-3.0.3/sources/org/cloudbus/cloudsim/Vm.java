...
public class Vm {
	...
	/*public static int getnoofCloudlets(int id)
	{
		return noofCloudlets[id];
	}
	public static void setnoofCloudlets(int id, int tempnoofCloudlets )
	{
		noofCloudlets[id]= tempnoofCloudlets;
	}*/
	/**
